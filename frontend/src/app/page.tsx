...
import {
  Upload, Play, Sparkles, LayoutDashboard, Twitter, Github, Linkedin, Mail,
  Wand2, Languages, MessageSquare, Mic2, Scissors, Zap
} from 'lucide-react';
...
const features = [
  {
    ...
    title: 'Precision Subtitles',
    description: 'Industry-leading accuracy using Whisper AI technology for perfect captions every time.',
    gradient: 'from-indigo-500 to-indigo-600'
  },
  {
    icon: <Languages className="w-6 h-6" />,
    title: 'Global Translation',
    description: 'Instantly translate your content into 100+ languages to reach a worldwide audience.',
    gradient: 'from-purple-500 to-purple-600'
  },
  {
    icon: <Zap className="w-6 h-6" />,
    title: 'Viral Shorts Generator',
    description: 'AI automatically identifies your most engaging moments and creates viral short clips.',
    gradient: 'from-pink-500 to-pink-600'
  },
  {
    icon: <Mic2 className="w-6 h-6" />,
    title: 'AI Audio Studio',
    description: 'One-click noise reduction and audio normalization for studio-quality sound.',
    gradient: 'from-amber-500 to-amber-600'
  },
  {
    icon: <LayoutDashboard className="w-6 h-6" />,
    title: 'Cross-Platform Resize',
    description: 'Intelligent landscape-to-portrait conversion with blurred backgrounds for TikTok & Reels.',
    gradient: 'from-emerald-500 to-emerald-600'
  },
  {
    icon: <Scissors className="w-6 h-6" />,
    title: 'Smart Silence Removal',
    description: 'Automatically detect and remove filler words and awkward pauses to keep viewers hooked.',
      ...
      <div className="min-h-screen flex flex-col relative overflow-hidden bg-[#020617]">
        ...
        <nav className="relative z-10 px-6 py-6 flex items-center justify-between max-w-7xl mx-auto w-full">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button onClick={() => router.push('/pricing')} className="text-sm font-medium text-slate-400 hover:text-white transition-colors">Pricing</button>
          </div>
        ...
        <main className="relative z-10 flex flex-col items-center justify-center text-center px-4 pt-20 pb-16">
          ...
          <div className="mt-24 relative max-w-6xl w-full animate-enter" style={{ animationDelay: '0.4s' }}>
            <div className="absolute -inset-1 bg-linear-to-r from-indigo-500 to-purple-600 rounded-2xl blur-lg opacity-30"></div>
